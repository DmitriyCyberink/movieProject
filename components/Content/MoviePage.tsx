...
export const MoviePage = () => {
  ...
  const getRandomPage = async (pagesNr: number) => {
    ...
    const topFiveMovies = moviesOnPage.slice(0, 100);
  ...
  return <div className=" bg-black">
      <div className="bg-black w-full h-full lg:bg-opacity-20">
        ...
        <div className="px-4 md:px-12 space-y-8">
          <div className=" grid lg:grid-cols-5 md:grid-cols-3 gap-4 pt-32">
            {movies
              ? movies.map((movie, movieKey) => {
                return (
                  <div
                    ...
                    >
                      <div className="relative group rounded-lg bg-zinc-900 col-span h-full m-2 px-2 py-2">
                        {movie.poster_path && (
                          <img
                        ...
                        <div className='absolute bottom-[7rem] right-1'>
                         ...
                         <p className='pt-5 pl-1 text-gray-300'>{movie.title}</p>
